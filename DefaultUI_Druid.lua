...
local L = LibStub("AceLocale-3.0"):GetLocale("DefaultUI_Druid")
local GetWoWVersion = ((select(4, GetBuildInfo())))
--local texturepackCheck    = "1.0.1.7"
--local texturepackDate     = "26/11/20"
local f = CreateFrame("Frame", "DefaultUI_Druid_Config", UIParent)
f:SetSize(50, 50)
f:RegisterEvent("PLAYER_LOGIN")
f:SetScript("OnEvent", function(self, event, ...)
  character = UnitName("player").."-"..GetRealmName()
  -- Config/Panel
  if not DefaultUI_Druid_Config then
    local DefaultUI_Druid_Config = {}
  end
  -- Color Init
...
local dialogFrameTexture 		= "Interface\\Addons\\DefaultUI_Druid\\textures\\extra\\dialogFrameTexture"
...
AbyssUISave:SetScript("OnEvent", function(self, event, arg1)
	if (event == "ADDON_LOADED" and arg1 == "DefaultUI_Druid") then
